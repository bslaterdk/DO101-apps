...
router.post('/get_weather', async function (req,res) {
  ...
  try {
    ...
    if(weather.cod == '404' && weather.main == undefined) {
      ...
      res.render('index', {weather: null, error: `Error: Invalid API Key: ${OWM_API_KEY}. Requested unit: ${UNITS}. Please see http://openweathermap.org/faq#error401 for more info.`});
    }
    else {
